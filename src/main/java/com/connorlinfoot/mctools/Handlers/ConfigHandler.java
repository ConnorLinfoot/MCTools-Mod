...
//		isSendData();
    ...
    public Property getDisplayCords() {
        return config.get(Configuration.CATEGORY_CLIENT, "Display Coordinates", false, "");
    }
    ...
    public Property getAutoGG() {
        return config.get(Configuration.CATEGORY_CLIENT, "Auto GG (Hypixel)", true, "");
    }

    public boolean isAutoGG() {
        return getAutoGG().getBoolean();
    }
